    ...
    <form onSubmit={onSubmit} className="space-y-3">
      <div>
        <div className="flex items-baseline justify-between mb-1.5">
          ...
          {isToday && (
            <span className="text-[10px] uppercase tracking-wide" style={{ color: FT.textMuted }}>
              Today
            </span>
          )}
        </div>
      ...
      {conflict ? (
        <div
          ...
          style={{ background: FT.warningBg, border: `1px solid ${FT.warning}40` }}
        >
          <div>
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              onClick={() => {
                setPending(true)
                router.push(`/fittrack/train/${conflict.id}/edit`)
              }}
            ...
            <button
              ...
              className="rounded-lg px-3 py-1.5 text-xs font-semibold"
              style={{ background: FT.danger, color: '#fff' }}
            >
              Override
            </button>
            <button
